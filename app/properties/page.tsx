...
import { createClient } from "@/lib/supabase/client" // <-- Import the simple client
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const checkUser = async () => {
      // 1. Get the user from local storage session
  ...
  // Show a loading screen while useEffect runs
  if (loading) {
    return (
